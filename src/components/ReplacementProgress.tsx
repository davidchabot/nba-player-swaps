...
import { startReplacement, subscribeToReplacementJob, getReplacementStatus } from "@/lib/api";
import { REPLACEMENT_STAGE_LABELS } from "@/lib/mock-data";
      ...
      try {
        ...
        unsubscribe = subscribeToReplacementJob(jobId, (updatedJob) => {
          const repJob: ReplacementJob = {
            ...
            trackId: updatedJob.track_id,
            avatarId: updatedJob.avatar_id,
