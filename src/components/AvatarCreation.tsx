...
import { Camera, Upload, User, ArrowRight, RotateCcw, Check } from "lucide-react";
...
export default function AvatarCreation() {
  const { setAvatar, setCurrentStep } = useApp();
  ...
  const startCamera = useCallback(async () => {
    try {
      ...
      // Camera not available, fall back to upload
      setMode("upload");
    }
  }, []);
  ...
  }, [imageUrl, avatarName, setAvatar, setCurrentStep]);
          ...
          <AnimatePresence mode="wait">
            {mode === "choose" && (
              ...
              >
                <button
                  onClick={startCamera}
                  className="flex flex-col items-center gap-3 p-8 rounded-xl bg-secondary/50 hover:bg-secondary transition-colors group"
                >
            ...
            {mode === "camera" && (
              ...
              >
                ...
                <div className="flex gap-3">
                  ...
                  <Button onClick={capturePhoto} className="flex-1 glow-primary">
            ...
            {mode === "upload" && (
              ...
              >
                <button
                  ...
                  className="w-full aspect-square rounded-xl border-2 border-dashed border-muted-foreground/20 hover:border-primary/50 transition-colors flex flex-col items-center justify-center gap-3"
                >
            ...
            {mode === "preview" && imageUrl && (
              ...
              >
                ...
                <div className="flex gap-3">
                  ...
                  <Button onClick={confirmAvatar} className="flex-1 glow-primary">
